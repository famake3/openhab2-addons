...
public class NinjaBlocksHandlerFactory extends BaseThingHandlerFactory {
    ...
    private final static Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS =
    		Sets.union(Sets.union(Sets.union(Sets.union(
    				Collections.singleton(THING_TYPE_NINJA_RF),
    				NinjaTriggerHandler.SUPPORTED_THING_TYPES_UIDS),
    				NinjaSocketHandler.SUPPORTED_THING_TYPES_UIDS),
    				NinjaTempHumidHandler.SUPPORTED_THING_TYPES_UIDS),
    				NinjaDoubleContactHandler.SUPPORTED_THING_TYPES_UIDS);
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(THING_TYPE_NINJA_RF)) {
        	...
        	return globalBridge.bridge;
        		...
        		|| thingTypeUID.equals(THING_TYPE_BUTTON) ) {
