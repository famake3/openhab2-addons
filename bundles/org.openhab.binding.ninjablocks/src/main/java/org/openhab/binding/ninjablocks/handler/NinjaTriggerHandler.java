...
import static org.openhab.binding.ninjablocks.NinjaBlocksBindingConstants.THING_TYPE_MOTION_SENSOR;
import static org.openhab.binding.ninjablocks.NinjaBlocksBindingConstants.THING_TYPE_BUTTON;
...
public class NinjaTriggerHandler extends BaseThingHandler implements NinjaThingEventListener {
	...
	public final static Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = 
			Sets.newHashSet(THING_TYPE_MOTION_SENSOR, THING_TYPE_BUTTON);
	...
	public void ninjaEvent(int code) {
		ChannelUID channelUID = getThing().
				getChannel(NinjaBlocksBindingConstants.TRIGGER).getUID();
